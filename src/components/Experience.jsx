...
export const Experience = () => {
  ...
  const handleSaveAnswer = (answer) => {
    const updatedAnswers = [...answers, { question: currentQuestion.Qid, answer }];
  ...
  const textSections = useMemo(() => [
    {
      ...
      title: "Welcome",
      subtitle: `Welcome to HireFlow! Sit back, relax, and enjoy the journey.`,
      answered: false,
    },
    {
      cameraRailDist: 1.5,
      ...
      title: "Reflection",
      subtitle: `Remember, every experience has shaped you into the person you are today.`,
      answered: false,
    },
    {
      cameraRailDist: -1,
      ...
      title: "Growth",
      subtitle: `Stay confident in your ability to learn and adapt.`,
      answered: false,
    },
    {
      cameraRailDist: 1.5,
      ...
      title: "Success",
      subtitle: `This journey is about showcasing your potential. You’ve got this!`,
      answered: false,
    },
    {
      cameraRailDist: -1,
      ...
      subtitle: `You are now ready to start the interview. Remember, this is your moment to shine!`,
      answered: false,
    },
  ], []);
  ...
  useFrame((_state, delta) => {
    ...
    textSections.forEach((textSection) => {
      ...
      if (normalizedDistance < 1 && !textSection.answered && !answeredSections.includes(textSection.Qid)) {
        ...
        setCurrentQuestion(textSection);
        
        // Update the answeredSections state
        setAnsweredSections((prev) => [...prev, textSection.Qid]);

        textSection.answered = true; 
